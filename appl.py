    ...
    if not st.session_state.logged_in:
       ...
       # Home Page
        if choice == "Home":
            ...
            st.image("https://images.unsplash.com/photo-1575505586569-646b2ca898fc", caption="Legal Document Analysis")
        ...
        # About Page
            ...
            st.image("https://via.placeholder.com/900x300?text=Powered+by+AI+and+Streamlit", caption="Powered by AI and Streamlit")
                # Same as your provided code for other pages
